...
use settings::{Settings as _, UiLanguageSetting};
...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    let t = |text| language.translate(text);
            ...
            items: vec![
                ...
                MenuItem::submenu(
                    Menu::new(t("Settings")).items([
                        ...
                        MenuItem::submenu(
                            Menu::new(t("Language")).items([
                                MenuItem::action(t("English"), zed_actions::SetUiLanguageEnglish)
                                    .checked(matches!(language, settings::UiLanguage::English)),
                                MenuItem::action(
                                    t("Simplified Chinese"),
                                    zed_actions::SetUiLanguageSimplifiedChinese,
                                )
                                .checked(matches!(
                                    language,
                                    settings::UiLanguage::SimplifiedChinese
                                )),
                            ]),
                        ),
                    ]),
