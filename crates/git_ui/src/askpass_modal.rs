            ...
            div()
                ...
                .child(
                    h_flex().gap_2()
                        ...
                        .child(
                            Label::new(translate_ui("You may need to configure git for Github.", cx))
                                .size(LabelSize::Small),
                        )
                        .child(Button::new("learn-more", translate_ui("Learn more", cx)).color(Color::Accent).label_size(LabelSize::Small).on_click(|_, _, cx| {
