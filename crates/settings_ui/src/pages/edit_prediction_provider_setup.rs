...
fn render_provider_dropdown(window: &mut Window, cx: &mut App) -> AnyElement {
    ...
    let current_provider_name = current_provider
        .display_name()
        .unwrap_or(crate::localized("No provider set", cx));
    ...
    v_flex()
        ...
        .min_w_0()
        .gap_1p5()
        .child(SettingsSectionHeader::new(crate::localized("Active Provider", cx)).no_padding(true))
        .child(
            h_flex()
                .pt_2p5()
                .w_full()
                ...
                .child(
                    v_flex()
                        ...
                        .min_w_0()
                        .max_w_1_2()
                        .child(Label::new(crate::localized("Provider", cx)))
                        .child(
                ...
                .child(
                    v_flex()
                        ...
                        .when_some(env_var_name, |this, env_var_name| {
                            this.child({
                                let label =
                                    crate::localized("Or set the {} env var and restart Zed.", cx)
                                        .replace("{}", env_var_name.as_ref());
